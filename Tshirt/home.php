...
<body>
  ...
  <div class="container py-5">
    <h2 class="text-center mb-4">Our T-Shirts</h2>
    <div class="row">
      <?php
        ...
        <div class="col-sm-6 col-md-4 mb-4">
          <div class="card shadow-sm h-100">
            ...
            <div class="card-body">
              ...
              <h5 class="card-title"><?= htmlspecialchars($row['prodect_name'] ?? 'No Name') ?></h5>   
              <span class="fw-bold">₹<?= number_format($row['prodect_price'] ?? 0, 2) ?></span>
      </div>
